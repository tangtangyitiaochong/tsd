								...
								<tr >
									<td  style="height:460px;PADDING-TOP:30pt; width: 840px;" valign="top">
                                        ...
                                        <div align="center">
											...
											<table cellpadding="0" cellspacing="0" class="css0086" style="height: 201px; filter:alpha(opacity=85)" >
												<tr >
												...
												<tr>
													<td style="PADDING-RIGHT:10pt; PADDING-LEFT:10pt; PADDING-BOTTOM:10pt; PADDING-TOP:10pt;
														...
														<table cellpadding="0" cellspacing="4" class="css0113">
															<tr>
																<td class="css0059" align="right" style="width: 71px"><label for="txtUser">合 同 号:</label></td>
													...
													<td class="css0144" style="height:20px;PADDING-RIGHT:5pt; PADDING-LEFT:5pt; PADDING-BOTTOM:5pt; PADDING-TOP:5pt; background-color: background;">
														<table cellpadding="0" cellspacing="4" class="css0113">																														
															<tr>
																...
																<td class="css0093" style="width: 105px"><div align="left"><span class="css0170"><input type="image" name="btnOK" id="btnOK" src="images/a_login.gif" style="border-width:0px;" onclick="checkup()" /></span></div>																
                                                                        </td>
															</tr>
...
<div>
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="/wEWBALlvNqHCALB2tiHDgK1qbSRCwLdkpmPAevkQMjSkMTkxdg2hK6xLLIw2dix" />
</div>
<!-- basic scripts -->
	   ...
	   if (hth == '' || password== ''){
			...
			success:function(data){
			   if (data == 'undefined'||data == null ||data == '' ){
				   ...
				   var hth = indexs.hth;
				   location.href = "AccountManage.jsp?pagenum="+hth;//location.href实现客户端页面的跳转  
